        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.hero.update',$hero->id) }}" enctype="multipart/form-data">                    
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control @error('brandName') is-invalid @enderror" id="brandName"
                                    name="brandName" type="text" value="{{ $hero->brandName }}"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control @error('brandText') is-invalid @enderror" id="brandText"
                                    name="brandText" type="text" value="{{ $hero->brandText }}"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control @error('mobile') is-invalid @enderror" id="mobile"
                                    name="mobile" type="number" value="{{ $hero->mobile }}" placeholder="Mobile" />
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control @error('email') is-invalid @enderror" id="email" name="email"
                                    type="email" value="{{ $hero->email }}" placeholder="Email" />
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control @error('welcome') is-invalid @enderror" id="welcome" name="welcome"
                            type="text" value="{{ $hero->welcome }}" placeholder="welcome" />
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                                    type="text" value="{{ $hero->name }}" placeholder="i.e. Fahim Sakib" />
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                ...
                                <input type="hidden" name="oldCover" value="{{ $hero->cover }}">
                            </div>
                            @error('cover')
                            <div class="alert alert-danger mt-1">{{ $message }}</div>
                            @enderror
                ...
                <div class="row justify-content-center mt-3">
                    <h4 class="text-center">Current Cover Image Preview:</h4>
                    <img src="{{ asset('storage/hero_section/'.$hero->cover) }}" alt="{{ $hero->cover }}"
                        style="width: 50%">
                </div>
            </div>
        </div>
