...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="mb-3">
                    <h4>Input Work or Experience Info</h4>
                </div>
                <form method="POST" action="{{ route('admin.work.store') }}">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control @error('experience') is-invalid @enderror" id="experience"
                                    name="experience" type="number" min="1" value="{{ old('experience') }}"
                                    placeholder="1" />
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating mb-3 mb-md-0">
                                <input class="form-control @error('heading') is-invalid @enderror" id="heading"
                                    name="heading" type="text" value="{{ old('heading') }}"
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control @error('details') is-invalid @enderror" id="details"
                            name="details" type="text" rows="3">{{ old('details') }}</textarea>
