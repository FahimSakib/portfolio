        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="text-end mb-3">
                    <a class="btn btn-primary" href="{{ route('admin.project.create') }}">Add New</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <a class="btn btn-primary" href="{{ route('admin.project.edit',$item->id) }}"><i
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-8">
                        ...
                        <p class="text-center mt-3">
                            <a href="{{ route('admin.project.create') }}" class="btn btn-success btn-lg">Add
                                New</a>
                        </p>
                    </div>
                </div>
